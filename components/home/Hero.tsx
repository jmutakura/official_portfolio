...
function Hero() {
	...
	return (
		<>
			...
			>
				<p className='text-xl mb-5'>Hey, I'm Jonathan Mutakura.</p>
				<h1 className='heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg'>
					I enjoy <span className='heroShiny1 text-fun-pink'>building</span> and{' '}
					<span className='heroShiny2 text-fun-pink'>architecting</span> great
					applications.
					<img
					...
					/>
					<img
						className='sqD bottom-[-300px] -right-1/4 sm:right-[-20%] lg:bottom-[-470px] lg:right-[-120px] w-[400px]'
